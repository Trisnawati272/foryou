...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo My Special Partner", "Aku ada pertanyaan nih buat kamu", "question").then(function () {
    Swal.fire("Jawab yang jujur ya Ai!").then(function () {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              Swal.fire(`Yakin ga suka sama ${sender}?`, '', 'error').then(function () {
                Swal.fire('Yaudah dehh kalo gitu Ai :((')
              })
            }
          })
        })
